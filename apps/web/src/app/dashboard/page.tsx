...
import { LinearCard, LinearTitle, LinearButton, LinearBadge } from '@/components/ui/linear'
      ...
      <header className="sticky top-0 z-50 border-b border-white/7 bg-white/2 backdrop-blur-2xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-4">
          <div className="flex items-center gap-2.5">
            <Image src="/rabbitmailer.png" alt="RabbitMailer" width={24} height={24} />
            <span className="text-sm font-semibold text-slate-100">RabbitMailer</span>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-10 space-y-8">
        ...
        <LinearCard padding="lg" border="accent" glow>
          <div className="flex flex-col items-center text-center py-8 gap-4">
            ...
            <div className="space-y-1">
              <LinearTitle size="sm">Campaign management coming in Stage 3</LinearTitle>
              <p className="text-sm text-slate-500 max-w-sm">
                The queue system, SMTP setup, and campaign builder will be added in the next stage.
              </p>
            </div>
          </div>
        </LinearCard>
